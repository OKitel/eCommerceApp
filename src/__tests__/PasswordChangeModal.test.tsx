...
describe('PasswordChangeModal', () => {
  ...
  it('renders modal title and form', () => {
    renderWithProviders(<PasswordChangeModal open={true} setOpen={jest.fn()} customer={mockCustomer} />);
  ...
  it('closes modal when cancel button is clicked', async () => {
    ...
    renderWithProviders(<PasswordChangeModal open={true} setOpen={setOpenMock} customer={mockCustomer} />);
