...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    'swiper/css/bundle': '<rootDir>/src/__mocks__/styleMock.ts',
    'swiper/css/autoplay': '<rootDir>/src/__mocks__/styleMock.ts',
    'swiper/css/free-mode': '<rootDir>/src/__mocks__/styleMock.ts',
